...
// TipoDib Bit(TipoindexAmp i, TipoChave k) { /* Retorna o i-esimo bit da chave k a partir da esquerda */
//   int c, j;
//   if (i == 0) return 0;
//   else {
//     c = k;
...
// short EExterno(TipoArvore p) { /* Verifica se p^ e nodo externo */
//   return (p->nt == Externo);
// }
...
//     p = CriaNoExt(k);
//     if (Bit(i, k) == 1) return (CriaNolnt(i, t, &p));
//     else
//       return (CriaNolnt(i, &p, t));
//   } else {
